...
(function($) {
	...
	$.fn.progressInitialize = function() {
		...
		var internationalization_list = [];

		if($('#internationalization_list').val() != '')
			internationalization_list = JSON.parse($('#internationalization_list').val());

		if(internationalization_list != null && internationalization_list != undefined && internationalization_list['rdr_inf_loading'] != undefined && internationalization_list['rdr_inf_loading'] != '' && internationalization_list['rdr_inf_loading'] != null)
			var loading_text = internationalization_list['rdr_inf_loading'];
		else
