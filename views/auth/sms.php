...
<div class="col-sm-12 col-md-6 col-md-offset-3">
    <div class="middle-form">
        <div class="middle-form-wrapper">
            ...
            <?php if ($isSent): ?>
                <p><?= Yii::t('app', 'Check your phone and enter the confirmation code') ?></p>
                ...
                <?php ActiveForm::end() ?>
            <?php else: ?>
                <p><?= Yii::t('app', 'We will now send you a free text message with an activation code to your mobile phone') ?></p>
